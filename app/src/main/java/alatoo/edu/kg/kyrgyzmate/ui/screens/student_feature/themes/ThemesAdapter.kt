...
import alatoo.edu.kg.kyrgyzmate.databinding.ItemThemeBinding
...
class ThemesAdapter(
...
) : DelegateAdapter<DriveItem, ThemesAdapter.ViewHolder>(DriveItem::class.java) {
    ...
    override fun bindViewHolder(
        model: DriveItem,
        viewHolder: ThemesAdapter.ViewHolder,
